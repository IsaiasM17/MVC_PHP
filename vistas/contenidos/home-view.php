...
<div class="full-box page-header">
    ...
    <p class="text-justify">
        Seleccione la opción que más le acomode, recuerde que este dashboard son opciones que intervienen en la consecución de los objetivos estrategicos que requiera el funcionario a cargo de su uso.
    </p>
</div>
<!-- Content -->
